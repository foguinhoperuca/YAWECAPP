...
exports.description = 'Create a YAWECAPP module. Basead in commonjs module.';
...
exports.template = function(grunt, init, done) {
		...
		init.process({}, [
				...
				init.prompt('repository', function(value, data, done) {
						value = "http://svn.sorocaba.sp.gov.br/svn/" + data.name;
						done(null, value);
				}),
				init.prompt('homepage', function(value, data, done) {
						value = "http://sistemas.sorocaba.sp.gov.br/" + (data.domain == "" ? "" : data.domain + "/") + data.name;
						done(null, value);
				}),
				init.prompt('bugs', function(value, data, done) {
						value = "http://redmine.sorocaba.sp.gov.br/projects/" + data.name;
						done(null, value);
				}),
